...
<head>
    ...
    <title>CAMGMAO -Fournisseur</title>
            ...
            <div class="flex-grow-1 mt-3 mt-sm-5">
                <div
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                        data-bs-whatever="@mdo"><i class='bx bx-check me-1'></i>Nouveau fournisseur </button>
                </div><br>
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="addEquipLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        <form action="soumission.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">CODE FOURNISSEUR</label>
                                <input type="text" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">ADDRESSE FOURNISSEUR</label>
                                <input type="text" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">TELEPHONE</label>
                                <input type="number" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">NOM DU RESPOSABLE</label>
                                <input type="number" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">REGISTRE COMMERCE</label>
                                <input type="text" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">IDENTIFIANT UNIQUE</label>
                                <input type="text" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">EMAIL</label>
                                <input type="emaiL" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            </div>
