...
<head>
    ...
    <title>CAMGMAO - Maintenance preventive</title>
...
<body>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Maintenance</span> preventive
        </h4>
            ...
            <div class="flex-grow-1 mt-3 mt-sm-5">
                <div
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEquip"
                        data-bs-whatever="@mdo"><i class='bx bx-check me-1'></i>Nouvelle prevention</button>
                </div><br>
                <div class="modal fade" id="addEquip" tabindex="-1" aria-labelledby="addEquipLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addEquipLabel">Créer une nouvelle prevention</h5>
                        ...
                        <form action="" >
                            ...
                            <div class="mb-3">
                                <label for="nomEquip" class="form-label">PHASE</label>
                                <input type="text" class="form-control" id="nomEquip" name="nomEquip" required>
                            </div>
                            <div class="mb-3">
