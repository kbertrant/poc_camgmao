...
<head>
    ...
    <title>CAMGMAO - Inscription</title>
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">CAMGMAO</span>
              </a>
            </div>
            <!-- /Logo -->
            ...
            <form class="mb-3" action="home.php" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" required class="form-control " id="phone" name="phone" placeholder="Entrer votre numero" />
                
              </div>
              <div class="mb-3">
                <label for="ville" class="form-label">Ville</label>
                <input type="text" required class="form-control  " id="ville"  name="ville" placeholder="Entrer votre ville" />
              </div>
              <div class="mb-3">
                <label for="name_ent" class="form-label">Le nom de votre entrreprise</label>
                <input type="text"  required class="form-control " id="name_ent"  name="name_ent" placeholder="Entrer votre entreprise" />
                
              </div>
              <div class="mb-3">
                <label for="rc_ent" class="form-label">Registre commerce entrreprise</label>
                <input type="text" required class="form-control " id="rc_ent"  name="rc_ent" placeholder="Entrer votre registre de commerce" />
