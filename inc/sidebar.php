<aside id="layout-menu" class="divPrincital layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
      <a href="{{route('home')}}" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bold ms-2">CAMGMAO</span>
      </a>
    </div>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div data-i18n="Clients">Parametres</div>
        </a>
        <ul class="menu-sub ">
          <li class="menu-item">
            <a href="listCatEquipement.php" class="menu-link">
              <div data-i18n="Categories equipement">Categorie Equipements</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="listEquipements.php" class="menu-link">
              <div data-i18n="Liste de equipements">Equipements</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="" class="menu-link">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-layout"></i>
          <div data-i18n="Clients">Maintenances</div>
        </a>
        ...
        <ul class="menu-sub ">
          ...
          <li class="menu-item">
            <a href="planification.php" class="menu-link">
      ...
      <!-- Cards -->
      <li class="menu-item ">
        <a href="ordretravail.php" class="menu-link">
          <i class="menu-icon tf-icons bx bx-store"></i>
          <div data-i18n="Basic">Ordres de travail</div>
        </a>
      </li>
      <!-- Cards -->
      <li class="menu-item ">
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-layout"></i>
          <div data-i18n="Produits">Gestion de stocks</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="fournisseur.php" class="menu-link">
          <i class="menu-icon tf-icons bx bx-store"></i>
