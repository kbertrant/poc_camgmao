...
<head>
    ...
    <link rel="stylesheet" href="assets/vendor/fonts/boxicons.css" type="text/css"/>
    <link rel="stylesheet" href="assets/css/bootstrap.min.css" type="text/css"/>
    <link rel="stylesheet" href="assets/css/lineicons.css" type="text/css"/>
    <link rel="stylesheet" href="assets/css/animate.cs" type="text/css"/>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="mb-4" method="POST" action="{{ route('login') }}">
              ...
              <div class="mb-3">
                <button class="btn btn-primary d-grid w-100" onclick="window.location.href='home.php'">Connexion</button>
              </div>
            </form>
